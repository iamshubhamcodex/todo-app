...
type TaskFormDataType = TaskType;

export default function EditTask() {
  const { activeCategory, categories, editingTask, editTask, setEditingTask } =
    useTaskStore();
  ...
  const initialTaskData: TaskFormDataType = {
    ...
    description: "",
    reminder: new Date(editingTask?.reminder ?? Date.now()),
    category: editingTask?.category ?? activeCategory.id ?? "",
